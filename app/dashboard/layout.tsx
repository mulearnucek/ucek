    ...
    <div className="flex flex-col h-screen font-sans">
      <div className="flex flex-1 overflow-hidden bg-gray-100">
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          <div className="flex items-center justify-between h-16 border-b border-gray-200 px-4 bg-[#2D3E50] text-white">
            {/* <div className="bg-white rounded-lg p-1 flex items-center justify-center gap-2 pl-4">
              <img src={Logo.src} alt="Logo" className="w-8 h-8 object-contain" />
              <small className="text-black">University College Of Engineering, Kariavattom</small>
            </div> */}
